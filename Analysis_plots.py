...
fig.gca().set(xlabel=r'x', ylabel=r'$S_{i}(x)$')
fig.savefig("KASAM_Theory/SAM_properties_1_2_Proof.png", close = True, verbose = True, dpi=500)
...
fig.gca().set(xlabel=r'x', ylabel=r'$S_{i}(x)$')
fig.savefig("KASAM_Theory/SAM_properties_3_Proof.png", close = True, verbose = True, dpi=500)
...
fig.gca().set(xlabel=r'$x$', ylabel=r'$y$')
fig.savefig("KASAM_Theory/pseudo_rehearsal.png", close = True, verbose = True, dpi=500)
